...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { bank_code: @bank_account.bank_code, bank_holder: @bank_account.bank_holder, bank_name: @bank_account.bank_name, bank_number: @bank_account.bank_number, bank_type: @bank_account.bank_type, branch_code: @bank_account.branch_code, branch_name: @bank_account.branch_name, user_id: @bank_account.user_id } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { bank_code: @bank_account.bank_code, bank_holder: @bank_account.bank_holder, bank_name: @bank_account.bank_name, bank_number: @bank_account.bank_number, bank_type: @bank_account.bank_type, branch_code: @bank_account.branch_code, branch_name: @bank_account.branch_name, user_id: @bank_account.user_id } }
